...
class PDFProcessor:
            ...
            for block in blocks:
                ...
                for line in lines:
                    ...
                    if prev_line_bbox and prev_line_page == page_num:
                        space_above = max(0, current_line_bbox[1] - prev_line_bbox[3])
                    ...
                    for line in block["lines"]:
                        for span in line["spans"]:
                            ...
                            text_blocks.append(TextBlock(
                                ...
                                is_italic="Italic" in span["font"] or span["flags"] & 2
                            ))
            doc.close()
            return text_blocks
    ...
    def is_likely_heading(self, text_block: TextBlock, font_analysis: Dict[str, Any]) -> bool:
        ...
        return sum(bool(ind) for ind in heading_indicators) >= 2
    ...
    def classify_heading_level(self, text_block: TextBlock, font_analysis: Dict[str, Any]) -> str:
        ...
        if (font_size >= font_analysis["title_threshold"] or
            (text_block.page_num == 0 and any(word in text.lower() for word in ['abstract', 'introduction']) and text_block.is_bold)):
            return "title"
    ...
    def extract_outline_from_pdf(self, pdf_path: str) -> Dict[str, Any]:
        ...
        for line in all_lines:
            ...
            if predicted_level == "Title" and not title:
                title = line["text"]
